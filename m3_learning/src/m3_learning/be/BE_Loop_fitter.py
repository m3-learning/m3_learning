...
from BElib.utils.be_loop import projectLoop, fit_loop, generate_guess, \
...
[docs]class BELoopFitter(Fitter):
    """
...
[docs]    def __init__(self, h5_main, be_data_type, vs_mode, vs_cycle_frac,
                 **kwargs):
        """
...
[docs]    def set_up_guess(self, h5_partial_guess=None):
        """
...
[docs]    def set_up_fit(self, h5_partial_fit=None, h5_guess=None, ):
        """
...
[docs]    def do_fit(self, override=False,):
        """
        Computes the Fit
...
[docs]def guess_loops_hierarchically(vdc_vec, projected_loops_2d):
    """
